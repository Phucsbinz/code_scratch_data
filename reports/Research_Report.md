...
- **Quy mô dữ liệu:** Phân tích 837 tin tuyển dụng IT (đã được làm sạch, loại bỏ các tin phi công nghệ).

## 2. Thị trường cần gì? (Market Snapshot)

### A. Vị trí & Cấp độ
- **Vị trí dẫn đầu:** 
  - Đa số nhu cầu nằm ở nhóm **Software Engineering**.
  - Sự bùng nổ của nhóm dữ liệu (Data/AI) cũng cho thấy sự chuyển dịch xu hướng.
  - Về số năm kinh nghiệm: Vị trí **Data Science** đòi hỏi kinh nghiệm cao nhất (trung bình 5.1 năm nếu có dữ liệu).
- **Kinh nghiệm:**
  - Nhu cầu cho **Senior** chiếm áp đảo. Doanh nghiệp cần những người có thể "vào việc ngay".
- **Học vấn / Bằng cấp:**
  - Nhà tuyển dụng chủ yếu yêu cầu **Bachelor'S**. Mặc dù IT là ngành trọng thực hành, nhưng bằng cấp cơ bản vẫn là tấm vé thông hành quan trọng ở nhiều doanh nghiệp lớn.

### B. Kỹ năng Công nghệ (Technical Skills)
- **Top Ngôn ngữ/Nền tảng:** Python, Sql, Java, C++, Golang. Đây là những "xương sống" của các hệ thống doanh nghiệp hiện nay.
- **Top DevOps/Cloud:** Ci/Cd, Docker, Microservices. Thị trường hiện nay yêu cầu Dev không chỉ biết code mà còn phải biết deploy và quản trị hạ tầng cơ bản.
- **Top Công cụ Data/AI:** Machine Learning, Llm, Power Bi, Rag, Tensorflow. Lĩnh vực trí tuệ nhân tạo và dữ liệu đang lên ngôi mạnh mẽ với nhu cầu lớn cho các kỹ năng chuyên biệt này.
- **Cơ sở dữ liệu (Database):** Môi trường lưu trữ dữ liệu chính xoay quanh các công nghệ Oracle, Postgresql, Mysql.
- **Nền tảng Cloud:** Doanh nghiệp chủ yếu triển khai hệ thống trên Aws, Azure, Gcp.

### C. Kỹ năng Mềm & Văn hóa (Non-technical & Work style)
- **Top Kỹ năng mềm:** Communication, Analytical, Teamwork, Mentoring, Work Independently. Kỹ năng giao tiếp và làm việc nhóm là bắt buộc để làm việc trong mô hình Agile.
- **Phong cách làm việc:** Documentation, Solid, Rest Api. Doanh nghiệp ưu tiên ứng viên hiểu rõ quy trình phát triển phần mềm chuẩn.
- **Ngoại ngữ:** Ngoại ngữ được yêu cầu phổ biến nhất là **English**, cho thấy tầm quan trọng của ngoại ngữ trong việc đọc tài liệu và giao tiếp.
