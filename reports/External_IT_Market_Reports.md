...
|---|---:|---:|---:|
| role_category | 813 | 97.13% | 12 |
| soft_skills | 773 | 92.35% | 15 |
| languages | 735 | 87.81% | 19 |
| experience_level | 680 | 81.24% | 8 |
| education | 600 | 71.68% | 4 |
| work_style | 500 | 59.74% | 14 |
| language_requirement | 495 | 59.14% | 5 |
| devops_tools | 339 | 40.50% | 10 |
| data_ai | 327 | 39.07% | 23 |
| databases | 238 | 28.43% | 13 |
| frameworks | 237 | 28.32% | 18 |
| methodology | 236 | 28.20% | 9 |
| cloud | 205 | 24.49% | 3 |
...
| Yêu cầu học vấn | Số JD | Tỷ lệ trên tổng JD |
|---|---:|---:|
| Bachelor's | 522 | 62.37% |
| Computer Science | 442 | 52.81% |
| Master's/PhD | 77 | 9.20% |
| College | 26 | 3.11% |

![Yêu cầu học vấn](charts/education_requirements.png)

**Nhận xét:** Dù IT là ngành coi trọng năng lực thực hành, bằng cử nhân và nền tảng Computer Science vẫn xuất hiện nhiều trong JD. Bằng cấp không thay thế được kỹ năng, nhưng vẫn là điều kiện lọc quan trọng ở nhiều doanh nghiệp.
